...
| 9 | 52 | GOE | Gate output enable (active-low) — pulsed per line | Pico GP8 |
...
| 26 | 35 | SOE | Source output enable — line latch strobe (NOT a level; ~2-clk pulse) | Pico GP5 |
| 27 | 34 | POL | Polarity control (toggles each line) | Pico GP7 |
...
clocked off the Pi's SSC. GSC and GSPU are also generated by the Pico, timed off
the Pi's HSYNC/VSYNC. Code: `pico_tcon/`.
...
The ESP32 handles only the touchscreen; all video timing is generated by the Pico.
